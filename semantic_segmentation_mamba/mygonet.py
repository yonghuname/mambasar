...
class mygoUNet2(nn.Module):
    def __init__(self,  dims,  in_channels=4,   class_num=1):
        ...
        self.decoder = nn.Sequential(
            DecoderBottleneck(out_channels, out_channels // 2),  # 768 -> 384
            DecoderBottleneck(out_channels // 2, out_channels // 4),  # 384 -> 192
            DecoderBottleneck(out_channels // 4, out_channels // 8),  # 192 -> 96
            DecoderBottleneck(out_channels // 8, out_channels // 16),  # 96 -> 48
            nn.Conv2d(out_channels // 16, class_num, kernel_size=1)  # 48 -> class_num
        )
